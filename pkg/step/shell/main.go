...
func (s *ShellStep) SetID(i string) {
	s.ID = i
}
...
func (s *ShellStep) GetRunOutputsDir() string {
	return s.RunOutputsDir
}

func (s *ShellStep) SetRunOutputsDir(d string) {
	s.RunOutputsDir = d
}
